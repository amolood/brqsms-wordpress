...
class DigitsSignupFields
{
            ...
            <div class="digits-form_tabs">
                ...
                if ($use_tab) {
                    ...
                    <div class="digits-form_tab-bar <?php echo $tab_bar_class; ?>">
                        ...
                        $phone_tab_class = 'digits_reg_use_phone';
                        $email_tab_class = 'digits_reg_use_email';

                        $action_type = 'phone';
                        if ($dig_default_tab == 'email' && $email_field) {
                            $action_type = 'email';
                        } else if (!$mobile_field && $email_field) {
                            $action_type = 'email';
                        }
                        ...
                        $email_tab_html = '<div data-change="action_type" data-value="email" class="digits-form_tab-item ' . $email_tab_class . '">' . __('Use Email Address', 'digits') . '</div>';

                        if ($dig_default_tab == 'email') {
                            if ($email_field) echo $email_tab_html;
                            if ($mobile_field) echo $phone_tab_html;
                        } else {
                            if ($mobile_field) echo $phone_tab_html;
                            if ($email_field) echo $email_tab_html;
                        }
                    ...
                    <div class="digits-form_body_wrapper">
                        ...
                        if ($mobile_field) {
                            ...
                            <div data-field-type="phone"
                                 class="digits-form_tab_body digits-phone_row <?php echo $active_class; ?>">
                                <?php
                        ...
                        if ($email_field) {
                            ...
                            <div data-field-type="email"
                                 class="digits-form_tab_body digits-email_row <?php echo $active_class; ?>">
                                <?php
    ...
    private function render_phone_field($show_label)
    {
        ...
        $show_asterisk = $this->asterisk;
        if(empty($this->reg_details['dig_reg_mobilenumber']) || $this->reg_details['dig_reg_mobilenumber'] !== 2){
            $show_asterisk = false;
        }
        digits_ui_reg_phone_field('', $userCountryCode, $userCountry, $show_label, $show_asterisk);
    ...
    {
        $show_asterisk = $this->asterisk;
        if(empty($this->reg_details['dig_reg_email']) || $this->reg_details['dig_reg_email'] !== 2){
            $show_asterisk = false;
        }

        digits_ui_reg_email_field('email', $show_label, $show_asterisk);
    }
                    ...
                    if ($passaccep > 0) {
                        ...
                        <div id="dig_cs_password"
                            ...
                            <div class="digits_password_eye-cont digits_password_eye">
                                <svg class="digits_password_eye-open digit-eye" xmlns="http://www.w3.org/2000/svg"
                                     width="24"
                                     height="24"
