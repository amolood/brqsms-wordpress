...
class Wizard
{
    ...
    {
        $find_code_link = 'https://dash.brqsms.com';

        $builder_buttons = [
            [
                'label' => __('How to use Builder', 'digits'),
                'href' => 'https://dash.brqsms.com/developers'
            ],
            [
        ...
        $steps = [
            ...
            'gateway_selector' => [
                ...
                'buttons' => [
                    [
                        'label' => __('Send OTP WhatsApp for <span>Free</span>', 'digits'),
                        'primary_color' => true,
            ...
            'firebase_gateway' => [
                'title' => __('Setup WhatsApp Gateway on this Page', 'digits'),
                'buttons' => [
                    [
                ...
                'layout' => 'bottom_view',
                'switch_to_tab' => 'whatsapp_gatewaytab',
                'show_next' => true,
            ...
            'use_form_type' => [
                ...
                'buttons' => [
                    [
                        'label' => __('I want to use <span>BrqSMS Forms</span>', 'digits'),
                        'primary_color' => true,
                ...
                'hint_text' => __('Please use <span>BrqSMS Forms</span> to experience enhanced security and seamless experience', 'digits'),
                'layout' => 'buttons',
                'show_next' => false
            ],
        ...
        <div class="untdor_wizard_no_gap show_next_previous">
            ...
            <div class="untdor_wizard_step_desc_list">
                <ol>
                    ...
                    <li>
                        <?php
                        $site = '<br /><a href="https://dash.brqsms.com" target="_blank">https://dash.brqsms.com</a>';
        ...
        <form class="untdor_wizard_feedback" autocomplete="off">
            <div class="untdor_wizard_center untdor_wizard_feedback_box untdor_wizard_no_gap untdor_wizard_fbox_offset"
                ...
                <div class="untdor_wizard_feedback_box_desc">
                    <?php echo esc_attr__('The basic setup of BrqSMS plugin has been done, now you can play with its settings to explore more features', 'digits'); ?>
                </div>
