...
function dig_add_menu_css()
{
    ...
    wp_enqueue_style('brqsms-theme', get_digits_asset_uri('/admin/assets/css/brqsms-theme.css'), array('digits-settings'), digits_version(), 'all');
...
{
    return get_digits_asset_uri('/assets/images/brqsms-logo.png');
}
...
/*    if (isset($_POST['dig_hid_addon_domain_notice'])) {
    ...
    if ($dig_hid_addon_domain_notice == -1 || true) {
        $request_link = 'https://dash.brqsms.com';
        ...
        <div class="digits_admim_conf">
            ...
            <div class="dig_log_setge">
                ...
                /*<div class="dig_admin_side">
                    ...
                    $data = dig_curl('https://dash.brqsms.com' . $plugin_version);
                    echo $data;
                </div>
                */
                ?>
...
function digits_add_admin_settings_scripts($hook)
{
    ...
    if (is_admin()) {
        ...
        $gateway_help = 'https://dash.brqsms.com/developers';
...
function dig_add_gs_css()
{
    ...
    wp_enqueue_style('brqsms-theme', get_digits_asset_uri('/admin/assets/css/brqsms-theme.css'), array('digits-gs-style'), digits_version(), 'all');
    ...
    return array(
        ...
        'forms' => array(
            ...
            'tabs' => array(
                ...
                'email' => array('label' => esc_attr__('Email Settings', 'digits'), 'function' => 'email'),
