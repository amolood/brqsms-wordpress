    ...
    if (!isset($_REQUEST['resume_configuration_wizard'])) {
        if (!wp_is_mobile()) {
            ...
            if ($resume_configuration_wiz == 1) {
                ...
                $notice_text = __('You left your BrqSMS plugin configuration in the middle, resume it to setup the plugin.', 'digits');
                                ...
                                <div class="dig_test_number_wrapper">
                                    <div class="digcon">
                                        ...
                                        <input dig-save="0" class="mobile" type="text"
                                               ...
                                               name="mobile_email" style="padding-left:107px !important;"></div>
...
{
    $placeholder = 'to:{to}, message:{message}, sender:{sender_id}, OTP : {otp}';
    $desc = '<i>' . __('You can directly use JSON payload or Enter Parameters separated by "," and values by ":"') . '</i><br />';
    $desc .= 'To Phone Number : {to}<br /> Message : {message}<br /> Sender ID : {sender_id}<br /> OTP : {otp}';
    ...
    $gateways = array(
            ...
            'twilio' => array(
                    ...
                    'inputs' => array(
                            ...
                            __('Message Sender ID') => array('text' => true, 'name' => 'mssid'),
                            __('Template Content SID') => array('text' => true, 'name' => 'cid', 'optional' => 1),
                    ),
            ),
            'birdgateway' => array(
                    'value' => 18,
                    ...
                    'inputs' => array(
                            __('Access Key') => array('text' => true, 'name' => 'accesskey'),
                            __('Channel ID') => array('text' => true, 'name' => 'channel_id'),
                            __('Workspace ID') => array('text' => true, 'name' => 'workspace_id'),
                            __('Template Name') => array('text' => true, 'name' => 'template-name', 'optional' => 1),
                            __('Language') => array('text' => true, 'name' => 'language', 'optional' => 1),
                            __('Template Project ID (optional)') => array('text' => true, 'name' => 'project_id', 'optional' => 1),
                    ),
            ),
    ...
    <div class="dig_admin_tab_grid">
        <div class="dig_admin_tab_grid_elem">
            ...
            <div class="digits_gateway_container digits_gateway_api_box">
                ...
                ?>
                <table class="form-table">
                    <tr class="disotp" <?php if ($digit_tapp == 13 || $digit_tapp == -1) echo 'style="display:none;"'; ?>>
            ...
            <div>
                <?php if ($gateway_type == 'sms') { ?>
                    <span class="dig_current_gateway"
                        ...
                        <?php
                        //printf(__('You should have paid <span>%s</span> plan to use this.', 'digits'), $gatewayName);
                        ?>
                    </span>
                <?php } ?>
                ...
                if (!$additional_gateway_installed) { ?>
                    ...
                    <a href="#"
                       tab="addonstab"
                       class="updatetabview dig-nav-tab digits_install_additional_gateways"><?php esc_html_e('Click Here'); ?></a>
                    </p><?php
                } ?>
            </div>
