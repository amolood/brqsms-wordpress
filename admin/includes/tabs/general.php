    ...
    <div class="dig_admin_tab_grid">
        <div class="dig_admin_tab_grid_elem">
            <table class="form-table">
                <tr>
                    <th scope="row"><label
                                class="no-top"><?php _e('Redirect WooCommerce account page to BrqSMS login page', 'digits'); ?> </label>
                    </th>
                    <td>
                ...
                ?>
                <tr>
                    <th scope="row"><label for="digits_enhance_wc_checkout_phonenumber"
                                           class="top-10"><?php _e('Override WooCommerce billing phone number field', 'digits'); ?>
                        </label></th>
                    <td>
                        <?php digits_input_switch('digits_enhance_wc_checkout_phonenumber', $digits_enhance_wc_checkout_phonenumber); ?></td>
                </tr>
                ...
                <?php
                $digits_add_countrycode_in_billing_phone = get_option('digits_add_countrycode_in_billing_phone', 1);
                ?>
                <tr>
                    <th scope="row"><label for="digits_add_countrycode_in_billing_phone"
                                           class="top-10"><?php _e('Add Country Code in billing phone number', 'digits'); ?>
                        </label></th>
                    <td>

                        <select id="digits_add_countrycode_in_billing_phone"
                                name="digits_add_countrycode_in_billing_phone">
                            <option value="0" <?php if ($digits_add_countrycode_in_billing_phone == 0) echo 'selected'; ?>>
                                <?php _e('No', 'digits'); ?>
                            </option>
                            <option value="1" <?php if ($digits_add_countrycode_in_billing_phone == 1) echo 'selected'; ?>>
                                <?php _e('Yes', 'digits'); ?>
                            </option>
                        </select>
                </tr>
...
function digits_settings_redirection()
{
    ...
    <div class="dig_admin_tab_grid">
        ...
        <div class="dig_admin_tab_grid_elem dig_admin_tab_grid_sec">
            <?php
            $hint = esc_attr__('Redirection settings only work for WordPress Native, WooCommerce and BrqSMS Native Forms.', 'digits');
            $hint .= "<br /><br />";
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <th scope="row">
                        <label class="top-10" for="digits_sameorigin_protection">
                            <?php _e('Allow BrqSMS forms in iframe', 'digits'); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="dig_ecr_desc"><?php _e('Help us improve BrqSMS by opting in to share non-sensitive plugin data', 'digits'); ?></p>
                    </td>
                </tr>
