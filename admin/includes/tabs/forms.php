    ...
    <div class="dig_admin_tab_grid">
        <div class="dig_admin_tab_grid_elem">
            <table class="form-table">
                <tr>
                    <th scope="row"><label class="top-10"><?php _e('Show Protected by BrqSMS', 'digits'); ?> </label>
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="dig_ecr_desc dig_sel_erc_desc">
                            <?php _e('This function only works on BrqSMS Native Forms', 'digits'); ?></p>

                    </td>
                </tr>

                <tr>
                    <th scope="row"><label class="top-10"><?php _e('Enable /wp-login.php Integration', 'digits'); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label class="top-10"><?php _e('Redirect /wp-login.php to BrqSMS', 'digits'); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label class="top-10"><?php _e('Show Mobile Number Placeholder', 'digits'); ?> </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label class="top-10"><?php _e('Show Field Labels', 'digits'); ?> </label>
                    </th>
                    <td>
                ...
                <tr id="showasteriskrow">
                    <th scope="row"><label class="top-10"><?php _e('Show asterisk (*) on required fields', 'digits'); ?>
                        </label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row" style="vertical-align:top;"><label for="login_reg_success_msg"
...
function digits_settings_auth_login()
{
    ...
    $dig_forgot_pass_otp_method = get_option('dig_forgot_pass_otp_method', 'both');
        ...
        <div class="dig_admin_tab_grid_elem">
            <div>
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row"><label
                                class="top-10"><?php _e('Allow Logins only from BrqSMS Secure Form', 'digits'); ?> </label>
                        </th>
                        <td>
                    ...
                    <tr class="enabledisableforgotpasswordrow">
                        <th scope="row"><label><?php _e('Forgot Password OTP Method', 'digits'); ?> </label></th>
                        <td>
                            <select name="dig_forgot_pass_otp_method" class="dig_custom_field_sel">
                                <option value="both" <?php if ($dig_forgot_pass_otp_method == 'both') echo 'selected'; ?>><?php _e('Both (Email or SMS)', 'digits'); ?></option>
                                <option value="email" <?php if ($dig_forgot_pass_otp_method == 'email') echo 'selected'; ?>><?php _e('Email Only', 'digits'); ?></option>
                                <option value="sms" <?php if ($dig_forgot_pass_otp_method == 'sms') echo 'selected'; ?>><?php _e('SMS/WhatsApp Only', 'digits'); ?></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="enabledisableforgotpasswordrow">
                        <th scope="row"><label
                                class="top-10"><?php _e('Use BrqSMS form as default Forgot Password form', 'digits'); ?>
                            </label>
                        </th>
                        <td>
            ...
            <table class="form-table">
                <tr>
                    <?php
                    $dig_login_default_tab = get_option('dig_login_default_tab', 'phone');
                    ?>
                    <th scope="row"><label><?php _e('Default Tab', "digits"); ?> </label></th>
                    <td>
                        <select name="dig_login_default_tab" class="dig_custom_field_sel">
                            <option value="phone" <?php if ($dig_login_default_tab == 'phone') {
                                echo 'selected';
                            } ?>><?php _e('Phone Number', 'digits'); ?></option>
                            <option value="email" <?php if ($dig_login_default_tab == 'email') {
                                echo 'selected';
                            } ?>><?php _e('Email Address', 'digits'); ?></option>
                        </select>
                    </td>
                </tr>
                <?php
                    ...
                    <td>
                        <select name="dig_login_captcha" class="dig_custom_field_sel">
                            ...
                            <option value="2" <?php if ($captcha == 2) {
                                echo 'selected';
                            } ?>><?php _e('reCAPTCHA/Turnstile/hCaptcha', 'digits'); ?></option>
...
function digits_settings_email()
{
    ?>
    <div class="dig_admin_head"><span><?php _e('Email Settings', 'digits'); ?></span></div>
...
function digits_settings_form_style()
{
    ...
    <div class="dig_admin_head">
        <span><?php _e('Native Form Style', 'digits'); ?></span><span
        ...
        <div style="pointer-events: none;position: absolute; bottom: 44px; right: 40px; ">
            ...
            ">
                ...
                <div style="margin-left: 12px">
                    ...
                    <div style="font-size: 16px;font-weight: bold"><?php esc_attr_e('Build with BrqSMS', 'digits'); ?></div>
                </div>
            </div>
        </div>
    </div>
