...
function digits_settings_auth_register()
{
    ...
    <div class="dig_admin_tab_grid">
                ...
                <table class="form-table">
                    <tr id="enableregistrationrow">
                        ...
                        <td>
                            ...
                            <!--                <p class="dig_ecr_desc"><?php /*_e('This function only works on BrqSMS Login/Signup Modal and Page', 'digits'); */ ?></p>-->
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row"><label
                                    class="top-10"><?php _e('Email Verification Method', 'digits'); ?> </label>
                        </th>
                        <td>
                            <?php
                            $digits_email_verification_method = get_option('digits_email_verification_method', 'otp');
                            ?>
                            <select name="digits_email_verification_method">
                                <option value="otp" <?php if ($digits_email_verification_method == 'otp') echo 'selected'; ?>><?php echo esc_attr__('OTP', 'digits'); ?></option>
                                <option value="link" <?php if ($digits_email_verification_method == 'link') echo 'selected'; ?>><?php echo esc_attr__('Link', 'digits'); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="dig_admin_tab_grid_elem dig_admin_tab_grid_sec">
            <?php
            $text = __('These settings only apply if you are using our Native Form, 3rd party plugin or theme forms. <br /><br /> These settings <b>do not</b> apply for forms built with BrqSMS Builder addon. ', 'digits');
