...
class DigitsThemeEditor
{
    ...
    public function __construct()
    {
        ...
        if (!empty($_REQUEST['digits-editor'])) {
            ...
            add_action('template_include', [$this, 'trigger_front_end']);
            add_action('plugin_loaded', [$this, 'front_end']);
        }
    }
            ...
            <div id="digits-editor-selector_controls" class="digits-editor-selector_controls">
                ...
                <div id="digits-editor-show_trigger_list" class="digits-editor_control">
                    ...
                    <div class="digits-editor_control_text">
                        <?php echo esc_attr__("Trigger BrqSMS Form", "digits"); ?>
                    </div>
                </div>
    ...
    public function trigger_front_end($template)
    {
    ...
    public $front_end_scripts_loaded = false;

    public function front_end()
    {
        if ($this->front_end_scripts_loaded) {
            return;
        }
        if(!function_exists('wp_verify_nonce')) {
            require ABSPATH . WPINC . '/pluggable.php';
        }
        $this->front_end_scripts_loaded = true;
